...
#define CTP_IRQ_MODE				(NEGATIVE_EDGE)	///< 設定INT pin 中斷為負緣驅動 
...
static int ctp_set_irq_mode(char *major_key , char *subkey,  ext_int_mode int_mode)
{
...
#endif  ///< for SYSCONFIG_GPIO_ENABLE

#ifndef AW_GPIO_INT_API_ENABLE
	...
	udelay(1);
#endif  ///< for AW_GPIO_INT_API_ENABLE
	return ret;  
}
